            ...
            steps {
                script {
                    sh '''
                        ...
                        docker buildx build --platform linux/amd64,linux/arm64 -tag asia-east1-docker.pkg.dev/jenkins-gke-project-457719/gc-artifact-repo/jenkins-gke-project:latest .                                           
